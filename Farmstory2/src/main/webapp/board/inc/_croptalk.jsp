...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<div id="sub">
        ...
        <section class="cate3">
        	<aside>
            	<img src="/Farmstory2/img/sub_aside_cate3_tit.png" alt="장보기"/>
                <ul class="lnb">
                	<li class="${type == 'story' ? 'on':'off'}"><a href="/Farmstory2/board/list.do?cate=croptalk&type=story">농작물 이야기</a></li>
