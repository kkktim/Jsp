            ...
            <form action="/Board1/user/proc/login.jsp" method="post">
                <table border="0">
                    <tr>
                        ...
                        <td><input type="text" name="uid" placeholder="아이디를 입력" required /></td>
                    </tr>
                    <tr>
                        <td><img src="/Board1/img/login_ico_pw.png" alt="비밀번호"/></td>
                        <td><input type="password" name="pass" placeholder="비밀번호 입력" required /></td>
                    </tr>
                </table>
